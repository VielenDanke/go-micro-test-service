module github.com/vielendanke/test-service
...
require (
	...
	github.com/unistack-org/micro-server-http v0.0.2-0.20201215085415-6ecfe94e7bb8
	github.com/unistack-org/micro/v3 v3.1.2
	github.com/unistack-org/protoc-gen-micro v0.0.2-0.20201130185255-50acf1d585c9
